          ...
          <article class="row">
            ...
            <div class="col-md-10 col-sm-10">
              <div class="panel panel-default arrow left">
                <div class="panel-body"><!-- 여기에 클릭버튼 해야징 -->
                  <header class="text-left">
                    <div class="comment-user"><i class="fa fa-user">${point.memberId }</i></div>
                    <time class="comment-date" datetime=""><i class="fa fa-clock-o"></i><fmt:formatDate value="${point.pointDate }" pattern="yyyy-MM-dd HH:mm"/></time>
                  </header>
